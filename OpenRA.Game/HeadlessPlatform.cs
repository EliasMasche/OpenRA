...
namespace OpenRA
{
	public sealed class HeadlessPlatform : IPlatform
	{
		...
		{
			throw new NotSupportedException("A headless game has no window. This code path should not run without a renderer.");
		}
		...
		{
			throw new NotSupportedException("A headless game has no fonts. This code path should not run without a renderer.");
		}
		...
		sealed class SilentSoundSource : ISoundSource
		{
			public void Dispose() { }
		}
