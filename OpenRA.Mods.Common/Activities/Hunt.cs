...
namespace OpenRA.Mods.Common.Activities
{
	...
	public class Hunt : Activity
	{
		...
		internal Hunt(Actor self, SnapshotReader _1, MiniYaml _2)
		{
			var attack = self.Trait<AttackBase>();
			targets = self.World.ActorsHavingTrait<Huntable>().Where(
				a => self != a && !a.IsDead && a.IsInWorld && a.AppearsHostileTo(self)
		...
		public override bool Tick(Actor self)
		{
			...
			QueueChild(new AttackMoveActivity(self, MoveSpec.WithinRangeOf(Target.FromCell(self.World, targetActor.Location), WDist.FromCells(2))));
